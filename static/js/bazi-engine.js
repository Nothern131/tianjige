...
(function (global) {
  ...
  // 时辰对应地支
  var SHICHEN_ZHI = { 0: '子', 1: '子', 2: '丑', 3: '丑', 4: '寅', 5: '寅', 6: '卯', 7: '卯', 8: '辰', 9: '辰', 10: '巳', 11: '巳', 12: '午', 13: '午', 14: '未', 15: '未', 16: '申', 17: '申', 18: '酉', 19: '酉', 20: '戌', 21: '戌', 22: '亥', 23: '亥' };

  // 时辰名称映射
  var SHICHEN_NAMES = { 子时: 0, 丑时: 2, 寅时: 4, 卯时: 6, 辰时: 8, 巳时: 10, 午时: 12, 未时: 14, 申时: 16, 酉时: 18, 戌时: 20, 亥时: 22 };

  // 纳音
  var NAYIN_ARR = ['海中金', '海中金', '炉中火', '炉中火', '大林木', '大林木', '路旁土', '路旁土', '剑锋金', '剑锋金', '山头火', '山头火', '涧下水', '涧下水', '城头土', '城头土', '白蜡金', '白蜡金', '杨柳木', '杨柳木', '泉中水', '泉中水', '屋上土', '屋上土', '霹雳火', '霹雳火', '松柏木', '松柏木', '长流水', '长流水', '沙中金', '沙中金', '山下火', '山下火', '平地木', '平地木', '壁上土', '壁上土', '金箔金', '金箔金', '覆灯火', '覆灯火', '天河水', '天河水', '大驿土', '大驿土', '钗钏金', '钗钏金', '桑柘木', '桑柘木', '大溪水', '大溪水', '沙中土', '沙中土', '天上火', '天上火', '石榴木', '石榴木', '大海水', '大海水'];
  ...
  // 调候用神
  var TIAOHOU = {
    甲: { 寅: ['丙', '癸'], 卯: ['庚', '丙丁'], 辰: ['庚', '丁'], 巳: ['癸', '庚丁'], 午: ['癸', '庚丁'], 未: ['癸', '庚丁'], 申: ['庚', '丁'], 酉: ['庚', '丁'], 戌: ['庚', '丁'], 亥: ['庚', '丁'], 子: ['庚', '丁'], 丑: ['庚', '丁'] },
    乙: { 寅: ['丙', '癸'], 卯: ['丙', '癸'], 辰: ['癸', '丙'], 巳: ['癸', '辛'], 午: ['癸', '丙'], 未: ['癸', '丙'], 申: ['丙', '癸'], 酉: ['癸', '丙'], 戌: ['癸', '辛'], 亥: ['丙', '戊'], 子: ['丙', '戊'], 丑: ['丙', '戊'] },
    丙: { 寅: ['壬', '庚'], 卯: ['壬', '己'], 辰: ['壬', '庚'], 巳: ['壬', '庚癸'], 午: ['壬', '庚'], 未: ['壬', '庚'], 申: ['壬', '戊'], 酉: ['壬', '己'], 戌: ['甲', '壬'], 亥: ['甲', '戊'], 子: ['壬', '己'], 丑: ['壬', '甲'] },
    丁: { 寅: ['甲', '庚'], 卯: ['甲', '庚'], 辰: ['甲', '庚'], 巳: ['甲', '庚'], 午: ['壬', '庚癸'], 未: ['甲', '壬庚'], 申: ['甲', '庚'], 酉: ['甲', '庚'], 戌: ['甲', '庚'], 亥: ['甲', '庚'], 子: ['甲', '庚'], 丑: ['甲', '庚'] },
    戊: { 寅: ['丙', '甲癸'], 卯: ['丙', '甲癸'], 辰: ['甲', '丙癸'], 巳: ['甲', '丙癸'], 午: ['壬', '丙'], 未: ['癸', '丙'], 申: ['丙', '甲癸'], 酉: ['丙', '癸'], 戌: ['甲', '丙癸'], 亥: ['甲', '丙'], 子: ['丙', '甲'], 丑: ['丙', '甲'] },
    己: { 寅: ['丙', '庚'], 卯: ['甲', '丙癸'], 辰: ['丙', '癸'], 巳: ['癸', '丙'], 午: ['癸', '丙'], 未: ['丙', '癸'], 申: ['丙', '癸'], 酉: ['丙', '癸'], 戌: ['戊', '丙癸'], 亥: ['丙', '甲'], 子: ['丙', '甲'], 丑: ['丙', '甲'] },
    庚: { 寅: ['戊', '甲丙'], 卯: ['丁', '甲丙'], 辰: ['甲', '丁'], 巳: ['壬', '戊丙'], 午: ['壬', '癸'], 未: ['丁', '甲'], 申: ['丁', '甲'], 酉: ['丁', '丙'], 戌: ['甲', '丁'], 亥: ['丁', '丙'], 子: ['丁', '甲丙'], 丑: ['丙', '丁甲'] },
    辛: { 寅: ['己', '壬'], 卯: ['壬', '甲'], 辰: ['壬', '甲'], 巳: ['壬', '甲'], 午: ['壬', '己'], 未: ['壬', '庚'], 申: ['壬', '甲'], 酉: ['壬', '甲'], 戌: ['壬', '甲'], 亥: ['壬', '丙'], 子: ['丙', '戊壬'], 丑: ['丙', '壬戊'] },
    壬: { 寅: ['庚', '戊'], 卯: ['戊', '辛'], 辰: ['甲', '庚'], 巳: ['壬', '辛'], 午: ['癸', '庚辛'], 未: ['辛', '甲'], 申: ['戊', '丁'], 酉: ['甲', '庚'], 戌: ['甲', '丙'], 亥: ['戊', '庚'], 子: ['戊', '丙'], 丑: ['丙', '戊丁'] },
    癸: { 寅: ['辛', '丙'], 卯: ['庚', '辛'], 辰: ['丙', '辛甲'], 巳: ['辛', '庚'], 午: ['庚', '壬癸'], 未: ['庚', '辛壬'], 申: ['丁', '甲'], 酉: ['辛', '丙'], 戌: ['辛', '甲壬'], 亥: ['庚', '辛戊'], 子: ['丙', '辛'], 丑: ['丙', '丁'] }
  };
  ...
  function calcYearGZ(year) {
    var baseYear = 1900, baseIdx = JIAZI_INDEX['庚子'] || 0;
  ...
  function calcDayGZ(year, month, day) {
    var baseYear = 1900, baseMonth = 1, baseDay = 1;
  ...
  function paipan(year, month, day, hour) {
    ...
    return {
      年柱: yearGZ, 月柱: monthGZ, 日柱: dayGZ, 时柱: hourGZ,
      日主: dayGan, 日支: dayZhi,
  ...
  function getShiShen(dayGan, otherGan) {
    ...
    var dwx = GAN_WUXING[dayGan], owx = GAN_WUXING[otherGan];
  ...
  function assessDayMasterStrength(dayGan, dayZhi, wuxingCount) {
    ...
    var total = 0;
    for (var k in wuxingCount) { total += wuxingCount[k]; }
  ...
  function generateWealthAnalysis(bazi) {
    ...
    var dayGan = bazi.日主, dayZhi = bazi.日支;
    var dwx = bazi.日主五行;
    ...
    // ===== 第一段：财星基础判断 =====
    lines.push('【财星格局】');
    lines.push('日主' + dayGan + '，五行属' + dwx + '。' + dwx + '克' + (WX_KE_BY[dwx] || '') + '为财星，' + WX_SHENG_BY[dwx] + '为食伤（生财之源）。');
    ...
    if (shiShang.count >= 2 && totalCai >= 1) {
      lines.push('食伤有力（' + shiShang.count.toFixed(1) + '）且财星有根——才华可直接转化为财富。创意、技术、表达能力是核心竞争力，宜走"以才生财"之路。');
    } else if (shiShang.count >= 2 && totalCai < 1) {
      lines.push('食伤有力但财星不足——才华横溢却难变现。问题不在能力，在商业转化。建议：1) 寻找能将创意变现的平台或合伙人；2) 学习商业思维，补足"才"与"财"之间的桥梁。');
    } else if (shiShang.count < 1 && totalCai >= 2) {
      lines.push('财星旺但食伤弱——有赚钱机会但缺乏主动创造财富的手段。建议：1) 借助他人之力（合作、雇佣）；2) 投资理财而非亲自创业；3) 培养一项可生财的技能。');
    }

    // 比劫夺财：竞争与合伙的风险
    if (biJie.count >= 2 && totalCai >= 1) {
      lines.push('比劫较旺（' + biJie.count.toFixed(1) + '）且财星有根——【财来财去之象】。朋友多、社交广，但合伙投资风险高。趋吉：选择可靠的长期合作伙伴，明确权责利；避凶：避免为朋友担保、冲动投资、轻信他人理财建议。');
      if (zhengCai.count >= 1) {
    ...
    if (guanSha.count >= 1.5 && totalCai >= 1) {
      ...
      lines.push('财旺官弱——求财心切但缺乏约束，需防急功近利、法律风险。建议：1) 重大决策请专业人士把关；2) 建立财务纪律，避免冲动消费。');
    }
    ...
    if (totalCai >= 2 && biJie.count >= 2) {
      advices.push('核心矛盾：财旺 vs 比劫夺财。建议：① 主业为主、副业为辅，守住基本盘；② 合作时明确权责利，书面约定；③ 分散投资，不把所有鸡蛋放一个篮子。');
    }
    if (totalCai >= 2 && shiShang.count < 1) {
      advices.push('核心矛盾：有财源但缺手段。建议：① 借力——找有执行力的合伙人；② 学习——掌握一门可生财的技能；③ 稳健——优先投资而非创业。');
    }
    if (shiShang.count >= 2 && totalCai < 1) {
      advices.push('核心矛盾：有才华但难变现。建议：① 找到对的平台和渠道；② 学习商业运营知识；③ 将自己的才华产品化、标准化。');
    }
    if (totalCai >= 3) {
      advices.push('财星过旺的隐忧：① 财多身弱，赚钱的同时消耗健康；② 欲望膨胀，需警惕贪念；③ 建议每年做财务复盘，设置消费上限。');
    }
    ...
    // ===== 第四段：综合评分 =====
    var score = Math.round(40 + totalCai * 12 + shiShang.count * 8 - biJie.count * 4 + (caiKu ? 8 : 0) + (guanSha.count >= 1 ? 5 : 0));
    score = Math.min(95, Math.max(25, score));

    lines.push('');
    if (score >= 70) {
      lines.push('【总评】财运格局优良（' + score + '分），财源广进，但需注意：财运好不等于一定能守住财，理财能力和风险意识同样重要。');
    } else if (score >= 45) {
      lines.push('【总评】财运中平（' + score + '分），有得有失，关键在于扬长避短。发挥自己的优势渠道，补足短板。');
    } else {
      lines.push('【总评】财运需经营（' + score + '分），先天财星不旺，但后天可补。以技能、知识、人脉为根基，稳步积累。');
    }
  ...
  function generateTalentAnalysis(bazi) {
    ...
    // 食伤：创新与表达能力
    if (shiShang.count >= 2) {
      lines.push('食伤旺盛（' + shiShang.count.toFixed(1) + '）——天生才华型。食神主创造、艺术、审美、表达；伤官主技术、发明、突破、独立思考。');
    ...
    // 印星：学习与思考能力
    if (yinXing.count >= 2) {
      lines.push('印星有力（' + yinXing.count.toFixed(1) + '）——学识渊博，善于深度思考和研究。学术、教育、咨询、研究领域大有可为。');
    ...
    if (shiShang.count >= 1.5 && yinXing.count >= 1.5) {
      lines.push('食伤配印——最佳天赋组合之一。既有创造力（食伤），又有深度思考力（印星）。类似"发明家+学者"的双重天赋。适合：科研、技术研发、战略咨询、内容创作。');
    } else if (shiShang.count >= 2 && yinXing.count < 1) {
      lines.push('食伤旺而印弱——创意充沛但缺乏系统性。建议：1) 找一位"军师"型搭档互补；2) 培养记录和复盘的习惯，将灵感系统化；3) 避免同时做太多事情，聚焦一个方向。');
    } else if (shiShang.count < 1 && yinXing.count >= 2) {
      lines.push('印旺而食伤弱——学识丰富但表达受限。适合幕后工作：研究、分析、规划、写作。建议：1) 刻意练习公开表达；2) 通过写作而非口述来展示思想。');
    }
    ...
    if (guanSha.count >= 1.5 && shiShang.count >= 1.5) {
      ...
      lines.push('官杀旺而食伤弱——执行力强但创意不足。适合管理、运营、执行类工作。建议：多接触不同领域的人和想法，拓宽视野。');
    } else if (guanSha.count < 1 && shiShang.count >= 2) {
      lines.push('食伤旺而官杀弱——创意丰富但执行力不够。适合自由职业、创意类工作。建议：建立外部约束机制（deadline、合作伙伴监督）。');
    }
    ...
    var score = Math.round(45 + shiShang.count * 10 + yinXing.count * 8 + guanSha.count * 5 + (caiXing.count >= 1 && shiShang.count >= 1 ? 8 : 0));
    score = Math.min(95, Math.max(30, score));

    lines.push('');
    lines.push('综合天赋评分：' + score + '分。' + (score >= 70 ? '天赋突出，找准方向即可大放异彩。' : (score >= 45 ? '天赋中平，需持续积累和刻意练习。' : '天赋需后天培养，找准赛道比天赋本身更重要。')));
  ...
  function generateBalanceAnalysis(bazi) {
    ...
    for (var k in wxCount) {
      total += wxCount[k];
      if (wxCount[k] > maxV) { maxV = wxCount[k]; maxWx = k; }
      if (wxCount[k] < minV) { minV = wxCount[k]; minWx = k; }
    }
    ...
    if (maxV - minV >= 3) {
      lines.push('五行严重失衡：' + maxWx + '过旺（' + maxV.toFixed(1) + '），' + minWx + '过弱（' + minV.toFixed(1) + '）。');
      // 过旺的后果
      if (maxWx === '木') lines.push('木过旺：肝气郁结，易怒急躁，决策冲动。需补金（决断力）制木，或补火（行动力）泄木。');
      else if (maxWx === '火') lines.push('火过旺：心火亢盛，急躁焦虑，失眠多梦。需补水（冷静）制火，或补土（包容）泄火。');
      else if (maxWx === '土') lines.push('土过旺：固执保守，行动迟缓，缺乏变通。需补木（灵活）疏土，或补金（效率）泄土。');
      else if (maxWx === '金') lines.push('金过旺：刚硬倔强，好斗好胜，人际关系紧张。需补火（热情）制金，或补水（柔和）泄金。');
      else if (maxWx === '水') lines.push('水过旺：思虑过度，优柔寡断，容易陷入情绪。需补土（稳重）制水，或补木（行动）泄水。');
      // 过弱的补救
      if (minWx === '木') lines.push('木过弱：缺乏目标感和行动力，建议：① 设定每日小目标；② 多接触大自然；③ 培养一个长期爱好。');
      else if (minWx === '火') lines.push('火过弱：缺乏热情和表达欲，建议：① 多参与社交活动；② 练习公开表达；③ 找到让自己兴奋的事。');
      else if (minWx === '土') lines.push('土过弱：缺乏安全感和稳定性，建议：① 建立固定的生活节奏；② 培养储蓄习惯；③ 减少不必要的变动。');
      else if (minWx === '金') lines.push('金过弱：缺乏决断力和原则性，建议：① 学会说"不"；② 建立自己的底线和标准；③ 练习快速决策。');
      else if (minWx === '水') lines.push('水过弱：缺乏深度思考和变通能力，建议：① 养成阅读习惯；② 独处冥想；③ 学习从不同角度看待问题。');
    ...
    if (wxCount[dwx] >= 4) {
      lines.push('身旺格——喜：' + (WX_KE_BY[dwx] || '') + '（泄秀，才华展现）、' + (WX_KE[dwx] || '') + '（克制，约束自律）。忌：' + (WX_SHENG[dwx] || '') + '（生扶，过犹不及）、' + dwx + '（比劫，竞争内耗）。');
      lines.push('趋吉：多做创意、表达、技术类工作（泄秀），给自己设定规则和deadline（约束）。');
      lines.push('避凶：避免过度学习（印星生扶）和过度社交（比劫），容易导致精力分散而一事无成。');
    } else if (wxCount[dwx] <= 1.5) {
      lines.push('身弱格——喜：' + (WX_SHENG[dwx] || '') + '（印星生扶，学习充电）、' + dwx + '（比劫帮身，朋友助力）。忌：' + (WX_KE[dwx] || '') + '（官杀克制，压力过大）、' + (WX_KE_BY[dwx] || '') + '（泄气，消耗过度）。');
    ...
    if (selfStr >= 3.5) {
      ...
      lines.push('反内耗策略：① 建立"小胜"习惯——每天完成一件小事建立信心；② 减少信息输入，专注当下；③ 找到一位能量充沛的伙伴带动自己。');
    } else {
      lines.push('内耗类型：平衡型。整体状态尚可，但偶尔会因外界变化而波动。');
      lines.push('反内耗策略：① 保持现有节奏，不盲目跟风；② 建立情绪缓冲机制——遇到大事先冷静24小时；③ 定期复盘，调整方向。');
    }
  ...
  var JIEQI_DATES = [
    { name: '立春', month: 2, day: 4 }, { name: '惊蛰', month: 3, day: 6 },
    { name: '清明', month: 4, day: 5 }, { name: '立夏', month: 5, day: 6 },
    { name: '芒种', month: 6, day: 6 }, { name: '小暑', month: 7, day: 7 },
    { name: '立秋', month: 8, day: 8 }, { name: '白露', month: 9, day: 8 },
    { name: '寒露', month: 10, day: 8 }, { name: '立冬', month: 11, day: 8 },
    { name: '大雪', month: 12, day: 7 }, { name: '小寒', month: 1, day: 6 }
  ];
  ...
  function evaluateDayunFortune(dayunGZ, dayGan, dwx, xiYongWx, jiShenWx, wxCount) {
    ...
    // 天干对日主关系
    if (dyGanWx === WX_SHENG[dwx]) score += 12;       // 印星生我，大吉
    else if (dyGanWx === dwx) score += 8;              // 比劫帮身，吉
    else if (dyGanWx === WX_SHENG_BY[dwx]) score += 4; // 食伤泄秀，小吉
    else if (dyGanWx === WX_KE[dwx]) score -= 12;      // 官杀克我，压力
  ...
  function generateLifelineAnalysis(bazi, gender, birthYear, birthMonth, birthDay) {
    ...
    lines.push('性别：' + (isMale ? '男' : '女') + '，' + (isYangYear ? '阳' : '阴') + '年' + (isMale ? '男' : '女') + '→大运' + direction + '。');
    lines.push('月柱：' + monthGZ + '，从月柱开始' + direction + '排大运。');
    lines.push('参考节气：' + targetJie.name + '（' + targetJie.month + '月' + targetJie.day + '日），起运年龄约' + qiyunAge + '岁。');
    ...
    lines.push('日主' + dayGan + '属' + dwx + '，喜用神为' + xiYongWx.join('、') + '，忌神为' + jiShenWx.join('、') + '。');
  ...
  function generateMonthlyAnalysis(bazi) {
    ...
    var monthLabels = ['正月·建寅', '二月·建卯', '三月·建辰', '四月·建巳', '五月·建午', '六月·建未', '七月·建申', '八月·建酉', '九月·建戌', '十月·建亥', '十一月·建子', '十二月·建丑'];
    var months = [];
    for (var i = 0; i < 12; i++) {
      var monthIdx = i + 1;
  ...
  global.BaziEngine = {
    ...
    /** 缓存 */
    getCache: function () { return baziCache; }
  };
