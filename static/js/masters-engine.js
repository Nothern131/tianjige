  ...
  var MASTERS = {
    guiguzi: {
      ...
      liuyaoOpeningTemplates: [
        '老夫观此卦，{日主}临{旺衰}之位，世应相配，{纳甲}之象已显。捭阖之间，吉凶自见。',
        '阴阳开阖，卦象昭然。今观此卦，{日主}居{旺衰}，世应分明，此事之机，藏于卦中。',
      ],
      liuyaoQuoteTemplates: [
        '鬼谷子曰："捭阖者，天地之道。" 此卦之机，在于阴阳开阖之间。{结论}，当知进退。',
        '《鬼谷子·飞箝》云："言有宗，事有君。" 卦象既明，当明其宗，知其君。{结论}，此乃卦中之道。',
      ],
      liuyaoClosingTemplates: [
        '老夫以捭阖之道观此卦：{结论}。阴阳有度，进退有时。{建议}，则可纵横自如。',
        '卦有捭阖，道有阴阳。{结论}。老夫断汝，{建议}，方得始终。',
        '捭之则通，阖之则固。{结论}。当知何时捭阖，何时进退。{建议}。',
      ],
    },
    jingfang: {
      id: 'jingfang',
      ...
      // 六爻专属模板
      liuyaoOpeningTemplates: [
        '吾以纳甲之法观此卦：{纳甲}纳{日主}，{旺衰}之势。天人感应，卦象已昭。',
        '京房纳甲，以干支配六亲，以世应定吉凶。今观此卦，{日主}临{旺衰}，六亲已备。',
      ],
      liuyaoQuoteTemplates: [
        '京房曰："纳甲者，以干支配卦，以世应论吉凶，以六亲断事类。" 此卦六亲世应，其机已见。',
        '《京氏易传》云："观象玩辞，明得失之机。" 汝当观此卦之象，玩其辞，自明得失。',
      ],
      liuyaoClosingTemplates: [
        '纳甲之学，以象配支，以支定卦。{结论}。吾断此卦，{建议}，则天人相应。',
        '卦象既明，干支已定。{结论}。京房之法，不外乎此。{建议}，可保无虞。',
        '纳甲推之，天机已显。{结论}。吾言尽于此，善自斟酌。{建议}。',
      ],
    },
    zhugeliang: {
      id: 'zhugeliang',
      ...
      // 六爻专属模板
      liuyaoOpeningTemplates: [
        '亮以六爻之法观此卦：{纳甲}之象已现，世爻临{旺衰}，此事之机，如观掌中物。',
        '夫六爻者，天地缩影也。今观此卦，{日主}居{旺衰}，世应相配，亮已洞悉其机。',
      ],
      liuyaoQuoteTemplates: [
        '亮曰："善弈者谋势，不善弈者谋子。" 此卦之势，汝当观其大体，勿拘小节。',
        '《诫子书》云："非淡泊无以明志，非宁静无以致远。" 观此卦，当静心思之，勿被表象所惑。',
      ],
      liuyaoClosingTemplates: [
        '亮观此卦，{结论}。卦如棋局，进退有度。{建议}，则可转危为安，逢凶化吉。',
        '六爻所示，亮已尽观。{结论}。汝但当{建议}，顺势而为，方不负此卦所示之机。',
        '卦象既明，亮言尽于此。{结论}。善自为之，{建议}，此乃亮之拙见。',
      ],
    },
    yuanli: {
      id: 'yuanli',
      ...
      // 六爻专属模板（相术视角，以象观爻）
      liuyaoOpeningTemplates: [
        '某以相术观卦，{日主}临{旺衰}之位。相由心生，卦由心显。六爻之象，与面相同理，皆由心造，皆可见命。',
        '骨相与卦象，其道一也。今观此卦，{日主}居{旺衰}，世爻{旺衰}之势，某已洞悉其机。',
      ],
      liuyaoQuoteTemplates: [
        '袁天罡曰："相由心生，命由己造。卦象如面相，世爻如命宫，动爻如流年运限。观卦如观人，观象如观骨。"',
        '《五行大义》云："形者，气之宅也。" 卦象即气之显，六亲即五行之动。{结论}，当观其形，知其气。',
      ],
      liuyaoClosingTemplates: [
        '某以相术观卦，{结论}。卦如人面，世如命宫，应如流年。{建议}，则卦人俱吉。',
        '相卦之道，以象观理。{结论}。某言尽于此，汝当{建议}，则命由己造。',
      ],
    },
    lichunfeng: {
      id: 'lichunfeng',
      ...
      // 六爻专属模板（天文历法视角，以星象配卦爻）
      liuyaoOpeningTemplates: [
        '淳风以天文历法观此卦：{日主}临{旺衰}之位，世爻居{旺衰}。夫卦者，天地之缩影；爻者，星象之应也。以星验卦，其理昭然。',
        '天象人事，理出一源。今观此卦，{日主}居{旺衰}，应爻{旺衰}，天干地支，皆合天象。',
      ],
      liuyaoQuoteTemplates: [
        '《乙巳占》云："天垂象，见吉凶，圣人象之。" 六爻之动，亦如星象之移，各有其应。{结论}，当以天象验之。',
        '李淳风曰："日月运行，五星列宿，皆与人事相应。" 卦中世应，如日月之照；动爻冲合，如五星之会。',
      ],
      liuyaoClosingTemplates: [
        '淳风以星象观卦，{结论}。卦如星盘，爻如星曜。{建议}，则星卦相合，天人相应。',
        '天象既明，卦理已定。{结论}。淳风断之，{建议}，方合天道。',
      ],
    },
    wangpu: {
      id: 'wangpu',
      ...
      // 六爻专属模板（太乙神数视角，以数理推卦）
      liuyaoOpeningTemplates: [
        '朴以太乙神数推演此卦：{日主}临{旺衰}之位。太乙者，天地之枢也，以数推卦，与六爻同理。世应之数，太乙已示其机。',
        '数者，天地之纪也。今观此卦，{日主}居{旺衰}，六爻之数，与太乙之轨，其理一也。',
      ],
      liuyaoQuoteTemplates: [
        '王朴曰："数者，天地之纪也。明数则明天道，明天道则知人事。" 此卦之动，数已显于爻中。{结论}，当以数推之。',
        '《太乙金镜式经》云："太乙行九宫，以应六爻之变。" 卦中之动，正如太乙之巡，各有其应。',
      ],
      liuyaoClosingTemplates: [
        '朴以太乙之数推卦，{结论}。数卦同源，其理一也。{建议}，则数卦相合，天机自现。',
        '太乙所示，卦理已明。{结论}。朴断此卦，{建议}，则数吉运顺。',
      ],
    },
    chenxizai: {
      id: 'chenxizai',
      ...
      // 六爻专属模板（先天象数视角，以易学解卦）
      liuyaoOpeningTemplates: [
        '希夷以先天之学观此卦：{日主}临{旺衰}之位。紫微以星曜论命，先天以象数推卦，其道一也。世爻者，命宫也；应爻者，流年也。',
        '象数之学，贯通天人。今观此卦，{日主}居{旺衰}，六爻之象，与紫微之曜，其理相通。',
      ],
      liuyaoQuoteTemplates: [
        '陈希夷曰："观天之道，执天之行。" 六爻之变，正如星曜之移。{结论}，当观其象，以定其机。',
        '《先天后天图》云："一阴一阳之谓道。" 六爻之动，阴阳相推，正如紫微四化，吉凶自见。',
      ],
      liuyaoClosingTemplates: [
        '希夷以先天观卦，{结论}。卦如星盘，爻如星曜。{建议}，则象数相合，天机自明。',
        '先天之学，贯通卦命。{结论}。希夷断之，{建议}，方得天道。',
      ],
    },
    shaoyong: {
      id: 'shaoyong',
      ...
      // 六爻专属模板（用于六爻分析场景）
      liuyaoOpeningTemplates: [
        '雍以先天之学观此卦：{纳甲}之象，世爻临{日主}，其数{旺衰}。卦有定数，理在其中。',
        '观此卦象，{日主}居{旺衰}位，动静之间，吉凶自见。此卦{纳甲}，其象已昭。',
      ],
      liuyaoQuoteTemplates: [
        '邵雍曰："观物以理，不以情。情则偏，理则正。" 汝观此卦，当以理观之，勿以情偏。',
        '《皇极经世》云："观之以理，则天下之事，可以理知。" 此卦之机，在于理而不在情。',
      ],
      liuyaoClosingTemplates: [
        '雍观此卦，{结论}。卦有理，理有数，数有归。{建议}，则事可成。',
        '卦象已明，理数已定。{结论}。当知进退之机，{建议}。',
        '先天之学，以象明理。{结论}。汝但当{建议}，余者听天数。',
      ],
    },
    xuzile: {
      id: 'xuzile',
    ...
    liuzhitong: {
      ...
      // 六爻专属模板（用于六爻分析场景）
      liuyaoOpeningTemplates: [
        '基观此卦，{纳甲}之象已现。{日主}临{旺衰}之位，此事之机，藏在卦中。',
        '夫六爻者，天地之缩影也。今观此卦，{日主}居{旺衰}，世应相配，吉凶已见其端。',
      ],
      liuyaoQuoteTemplates: [
        '刘伯温曰："善弈者谋势，不善弈者谋子。" 此卦之势，汝当观其大体，勿拘小节。',
        '基尝言："天时、地利、人和，三者得其一，可成大事；三者俱全，无往不利。" 此卦三者孰得孰失，汝自察之。',
      ],
      liuyaoClosingTemplates: [
        '基观此卦，{结论}。卦如棋局，进退有度。{建议}，则可转危为安，逢凶化吉。',
        '六爻所示，{结论}。基以为，当审时度势，{建议}，此乃趋吉之道。',
        '卦象既明，机势已见。{结论}。基言尽于此，善自为之。{建议}。',
      ],
    },
    wanminying: {
      id: 'wanminying',
      ...
      // 六爻专属模板（三命通会视角，星命合参）
      liuyaoOpeningTemplates: [
        '民英以三命通会观此卦：{日主}临{旺衰}之位。三命者，禄命、子平、星宗也。今以六爻合参，世爻如命宫，动爻如流年，应爻如大运。',
        '三命通会，万法归宗。今观此卦，{日主}居{旺衰}，以星命合参之法推之，其机已现。',
      ],
      liuyaoQuoteTemplates: [
        '《三命通会》云："命者，天之令也；运者，地之期也。卦者，天地之象也。" 世爻即命宫，动爻即运限，应爻即流年，此三者合参，方得全貌。',
        '万民英曰："论命不可执一，当以禄命、子平、星宗，合而观之。" 论卦亦然，世应动变，合参方明。',
      ],
      liuyaoClosingTemplates: [
        '民英以三命通会断卦：{结论}。世如命宫，应如流年，动如运限。{建议}，则卦命相合，三命可参。',
        '三命通会，至此已明。{结论}。民英以为，{建议}，方为万全之策。',
      ],
    },
    zhangnan: {
      id: 'zhangnan',
    ...
    songhuibin: {
      ...
      // 六爻专属模板（奇门学术视角，以模型解卦）
      liuyaoOpeningTemplates: [
        '惠彬以奇门学术模型观此卦：{日主}临{旺衰}之位。奇门者，时空能量之模型也；六爻者，阴阳变动之数理也。二者同出一源，皆可建模推演。世爻为坐标原点，动爻为变量参数。',
        '学术化六爻，以逻辑为纲。今观此卦，{日主}居{旺衰}，世应相配，六亲分布，皆可建模分析。',
      ],
      liuyaoQuoteTemplates: [
        '宋惠彬曰："奇门遁甲，是古人对时空能量场的数学建模。六爻之世应动变，正是阴阳二气在时空中的运动轨迹。{结论}，当以模型推之。"',
        '惠彬云："卦如坐标系，爻如变量点。世为原点，应为目标，动爻为过程函数。解卦即解方程，求其根即得吉凶。"',
      ],
      liuyaoClosingTemplates: [
        '惠彬以学术模型断卦：{结论}。卦如模型，爻如变量，世应如坐标。{建议}，则模型可解，吉凶可推。',
        '学术化解卦，至此已明。{结论}。惠彬以为，{建议}，则理数学明，方为正道。',
      ],
    },
    zhougong: {
      id: 'zhougong',
    ...
    shaoyanhe: {
      ...
      // 六爻专属模板（大六壬视角，以课体解卦）
      liuyaoOpeningTemplates: [
        '彦和以六壬神课观此卦：{日主}临{旺衰}之位。六壬以天地盘推事，六爻以世应论局，其理一也。世爻如月将，应爻如日辰，动爻如三传。',
        '六壬者，天地之机也。今观此卦，{日主}居{旺衰}，世应三传，其象已备。以六壬之法参之，其机自明。',
      ],
      liuyaoQuoteTemplates: [
        '邵彦和曰："六壬之妙，在象不在辞。观象知机，方为上乘。" 六爻之象，正如六壬之课。世爻即月将，动爻即三传，观其象则知其机。',
        '彦和尝言："天地盘开，鬼神莫逃。" 六爻之动，正如天地盘之转，世应之配，正如月将日辰之会。',
      ],
      liuyaoClosingTemplates: [
        '彦和以六壬观卦，{结论}。世如月将，应如日辰，动如三传。{建议}，则壬卦合参，吉凶可判。',
        '六壬所示，卦理已明。{结论}。彦和断之，{建议}，方得天机。',
      ],
    },
    chengongxian: {
      id: 'chengongxian',
