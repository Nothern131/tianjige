...
(function (global) {
  ...
  var MASTERS = {
    ...
    xuzile: {
      ...
      // 六爻专属模板（子平视角，以十神配六爻）
      liuyaoOpeningTemplates: [
        '子平以十神之法观此卦：{日主}临{旺衰}之位。十神者，六亲之祖也。世爻即命宫，动爻即运限，以十神论六亲，其理相通。',
        '十神与六亲，同源异流。今观此卦，{日主}居{旺衰}，世爻所临，正是汝命之十神所在。',
      ],
      liuyaoQuoteTemplates: [
        '《渊海子平》云："用神者，八字之提纲也。" 卦中之世爻，犹八字之用神，提纲既立，全局皆活。',
        '徐子平曰："八字以用神为要，六爻以世爻为基。用神有力，则八字有根；世爻得位，则六爻有主。"',
      ],
      liuyaoClosingTemplates: [
        '子平以十神断卦：{结论}。世如命宫，应如大运，动如流年。{建议}，则卦命相参，万事可明。',
        '子平之法，至此已明。{结论}。子平以为，{建议}，方为万全之策。',
      ],
    },
    liuzhitong: {
      id: 'liuzhitong',
    ...
    yelan: {
      ...
      // 六爻专属模板（格局视角，以卦论格局）
      liuyaoOpeningTemplates: [
        '兰以格局清浊观此卦：{日主}临{旺衰}之位。卦有格局，犹命有格局。世爻得位、六亲生扶，则为清局；世爻失位、六亲相克，则为浊局。',
        '卦如命盘，爻如星曜。今观此卦，{日主}居{旺衰}，世应之配，六亲之生，格局已分清浊。',
      ],
      liuyaoQuoteTemplates: [
        '《命理正宗》云："一清到底有精神，管取生平富贵真。" 卦之清者，世爻得位、用神有力、六亲相生，一气呵成；卦之浊者，世应相冲、用神受损、六亲相克，杂乱无章。',
        '叶兰曰："格局清浊，一卦可知。清则吉，浊则凶。" 今观此卦，{结论}，清浊已辨。',
      ],
      liuyaoClosingTemplates: [
        '兰以格局断卦：{结论}。卦之清者，世应相配，六亲相生；卦之浊者，世应相冲，六亲相克。{建议}，则卦局由浊转清，事可成矣。',
        '正宗断卦，格局为先。{结论}。兰以为，{建议}，方为正本清源之道。',
      ],
    },
    shenxiao: {
      id: 'shenxiao',
      ...
      // 六爻专属模板（真诠视角，以格局顺逆断卦）
      liuyaoOpeningTemplates: [
        '孝瞻以格局顺逆观此卦：{日主}临{旺衰}之位。卦之顺者，世爻生应爻、用神生世爻；卦之逆者，世爻克应爻、用神冲世爻。顺逆既定，吉凶已判。',
        '子平真诠，重在格局顺逆。今观此卦，{日主}居{旺衰}，世应之配，用神之得失，顺逆之机，已了然于心。',
      ],
      liuyaoQuoteTemplates: [
        '《子平真诠》云："格局既定，顺逆判焉。顺者如顺水行舟，逆者如逆风掌舵。" 卦之世应，亦如此理。{结论}，顺逆已明。',
        '沈孝瞻曰："格局不顺，虽吉不真；格局得顺，虽凶可变。" 今观此卦，世应相配，用神得位，其机已见。',
      ],
      liuyaoClosingTemplates: [
        '孝瞻以格局顺逆断卦：{结论}。卦之顺者，世应相生，用神有力；卦之逆者，世应相冲，用神受损。{建议}，则卦局由逆转顺，事可成矣。',
        '子平真诠，至此已明。{结论}。孝瞻以为，{建议}，方为正道。',
      ],
    },
    renqiao: {
      id: 'renqiao',
    ...
    zhenguan: {
      ...
      // 六爻专属模板（约言视角，以简驭繁）
      liuyaoOpeningTemplates: [
        '素庵以约言之法观此卦：{日主}临{旺衰}之位。卦之道，在于五行生克。世应相配，六亲相生，约而言之，不过数语。',
        '大道至简，卦亦如此。今观此卦，{日主}居{旺衰}，世应之机，约而言之，吉凶已明。',
      ],
      liuyaoQuoteTemplates: [
        '《命理约言》云："论命之法，约在五行生克。" 论卦亦然，世爻之旺衰、应爻之动静、六亲之生克，约而言之，卦理已明。',
        '陈素庵曰："观卦如观棋，关键一着而已。" 此卦之关键，在于世爻与动爻。{结论}，一着定吉凶。',
      ],
      liuyaoClosingTemplates: [
        '素庵以约言断卦：{结论}。卦理至简，不过世应生克。{建议}，则简明扼要，事可成矣。',
        '约言断卦，至简至明。{结论}。素庵以为，{建议}，方为至要之道。',
      ],
    },
    shutong: {
      id: 'shutong',
      ...
      // 六爻专属模板（星命合参视角）
      liuyaoOpeningTemplates: [
        '继英以星命合参观此卦：{日主}临{旺衰}之位。卦中之世应，正如星宗之命宫与运限。星命合参，卦亦合参，其理一也。',
        '六爻者，天地之缩影；星宗者，天象之推演。今观此卦，{日主}居{旺衰}，以星命合参之法推之，其机已见。',
      ],
      liuyaoQuoteTemplates: [
        '《星平会海》云："星平二家，合而参之。" 卦之世爻如命宫，卦之动爻如运限，卦之应爻如流年。星命合参，卦亦合参。',
        '舒继英曰："纲举则目张，命定则卦明。" 此卦之世应，正如命盘之星曜，合参观之，吉凶自现。',
      ],
      liuyaoClosingTemplates: [
        '继英以星命合参断卦：{结论}。世如命宫，动如运限，应如流年。{建议}，则星命卦三参，万事可明。',
        '星平会海，至此已明。{结论}。继英以为，{建议}，方为万全之策。',
      ],
    },
    weixian: {
      id: 'weixian',
      ...
      // 六爻专属模板（实证视角，以事实断卦）
      liuyaoOpeningTemplates: [
        '千里以实证之法观此卦：{日主}临{旺衰}之位。卦之道，在于实证。世爻之动，必有应验；爻象之变，必有后果。以事实验卦，卦理自明。',
        '千里命稿，验之于实。今观此卦，{日主}居{旺衰}，世应之配，动变之机，皆需以实证验之。',
      ],
      liuyaoQuoteTemplates: [
        '《千里命稿》云："命理之学，贵在验证。" 卦亦如此。世爻动而应爻应，此乃实证；爻象变而卦理明，此乃验证。{结论}，卦之实证，已验于此。',
        '韦千里曰："卦不妄成，爻不妄动。" 每一动爻，必有其应；每一卦象，必有其验。观此卦，{结论}，实证已明。',
      ],
      liuyaoClosingTemplates: [
        '千里以实证断卦：{结论}。卦之道，不在玄虚，而在实证。{建议}，则卦验事实，事验卦理。',
        '千里命稿，验之于卦。{结论}。千里以为，{建议}，则卦验两全。',
      ],
    },
    yuanshu: {
      id: 'yuanshu',
      ...
      // 六爻专属模板（探源视角，溯源卦理）
      liuyaoOpeningTemplates: [
        '树珊以探源之法观此卦：{日主}临{旺衰}之位。卦之源，在于阴阳；卦之流，在于六亲。溯其源头，则卦理自明。今观此卦，{日主}居{旺衰}，其源已溯。',
        '探源者，穷其根本也。卦之源在阴阳，爻之源在动变。今观此卦，{日主}居{旺衰}，世应之源，已在卦中。',
      ],
      liuyaoQuoteTemplates: [
        '《命理探源》云："命理之源，始于阴阳，流于干支。" 卦之源亦如此。阴阳为卦之本，六亲为卦之流，动变为卦之变。{结论}，溯源已明。',
        '袁树珊曰："论卦如考古，须层层深入。" 今观此卦，世应之源、动变之机，已溯源而明。{结论}，源清流洁。',
      ],
      liuyaoClosingTemplates: [
        '树珊以探源断卦：{结论}。卦之源在阴阳，爻之变在动静。{建议}，则溯源返本，卦理自明。',
        '命理探源，至此已明。{结论}。树珊以为，{建议}，方为正本清源之道。',
      ],
    },
    linxuan: {
      id: 'linxuan',
      ...
      // 六爻专属模板（人鉴视角，以象鉴卦）
      liuyaoOpeningTemplates: [
        '庚白以人鉴之法观此卦：{日主}临{旺衰}之位。以象鉴卦，犹以人鉴命。世爻之象，如人之面；动爻之变，如人之运。今观此卦，{日主}居{旺衰}，以象鉴之，其机已现。',
        '卦如人面，爻如命运。今观此卦，世爻临{旺衰}，动爻有变，以象鉴卦，吉凶已明。',
      ],
      liuyaoQuoteTemplates: [
        '《人鉴·命理》云："以人为鉴，可知命之得失。" 卦亦如此。世爻如命，应爻如运，动爻如流年。观此卦之象，如观人之面。{结论}，人卦合一。',
        '林庚白曰："卦如人之面，一卦一世界。" 今观此卦，{日主}临{旺衰}，世应之配，动变之机，已如面如掌。',
      ],
      liuyaoClosingTemplates: [
        '庚白以人鉴断卦：{结论}。卦如人面，世如命宫，动如流年。{建议}，则卦人相参，得失自明。',
        '人鉴断卦，至此已明。{结论}。庚白以为，{建议}，方为善鉴之道。',
      ],
    },
    songhuibin: {
      id: 'songhuibin',
