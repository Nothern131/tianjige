...
(function (global) {
  ...
  /** 解读签文单句（扩充版：多意象匹配 + 事域 fallback + 结构分析） */
  function interpretPoemLine(line, domainKey) {
    // 意象词库：每个事域对应一组意象及其解读
    var interpretations = {
      career: {
        龙: '龙为贵人之象，事业上有贵人相助或升迁之机，宜主动争取。',
        虎: '虎为威猛之象，事业上需展现魄力与决断，但不可过于强势逼人。',
        凤: '凤鸣朝阳，事业上将有亮眼表现，适合争取晋升或展示成果。',
        水: '水主流动与智慧，事业上宜灵活应变、顺势而为，忌固守成规。',
        山: '山主稳固，事业根基扎实，但需防固步自封，适当拓展视野。',
        风: '风主变动，事业上可能有职务或方向调整，宜随机应变、提前布局。',
        云: '云主遮蔽与机遇并存，事业上可能有不确定因素，需耐心等待云开见日。',
        日: '日主光明，事业前景明朗，宜积极进取，把握当前上升期。',
        月: '月主阴柔与沉静，事业上宜以柔克刚，韬光养晦、不宜强攻。',
        花: '花主繁荣与生机，但花开花落有时，事业需把握时机、不可拖延。',
        春: '春主新生与萌动，事业有新的开始或转机，宜主动出击。',
        秋: '秋主收获与收敛，事业成果即将显现，但需防得意忘形、留有余地。',
        金: '金主刚毅与财权，事业上适合争取管理岗位或决策权。',
        玉: '玉主温润与品质，事业上宜以德服人，口碑积累带来长期回报。',
        剑: '剑主锋芒与决断，事业上需果断处理问题，但不宜锋芒太露。',
        桥: '桥主连接与过渡，事业上可能有岗位转换或跨部门合作机会。',
        路: '路主前行与方向，事业上宜明确目标、坚定步伐，忌犹豫不决。',
        星: '星主指引与希望，事业上可能有新的方向指引，宜开阔视野。',
      },
      love: {
        龙: '龙为贵人之象，感情中可能有贵人引荐或缘分降临，宜多社交。',
        凤: '凤为良缘之象，单身者桃花运旺，有伴者感情升温、关系更近。',
        水: '水主柔情与包容，感情中需多些温柔体贴，顺其自然、不急于求成。',
        花: '花主桃花与心动，感情有新机遇，但需分辨是正缘还是烂桃花。',
        月: '月主阴晴圆缺，感情中需接受不完美，珍惜当下、坦诚沟通。',
        春: '春主萌动与新生，感情有新的开始，宜主动表达心意。',
        金: '金主坚定与承诺，感情中需明确态度、信守承诺，忌三心二意。',
        玉: '玉主温润与长久，感情宜以真心相待，细水长流。',
        鸟: '鸟主自由与迁徙，感情中可能有异地或分离之象，需用心维系。',
        影: '影主虚幻与暧昧，感情中可能有第三者或不确定因素，宜擦亮眼睛。',
        缘: '缘主命中注定，感情有善缘，宜把握、主动经营。',
        心: '心主真诚，感情贵在真心相待，忌猜疑与冷漠。',
      },
      wealth: {
        金: '金主财富，财运上升，但需防贪多嚼不烂，量力而行。',
        水: '水主流动，钱财来去较快，需做好理财规划、留有余粮。',
        山: '山主积蓄与稳健，财运稳健，适合长期投资、不宜短线炒作。',
        秋: '秋主收获，之前的投资或努力将有回报，宜落袋为安。',
        宝: '宝主珍贵与机遇，有意外之财或贵重机遇，宜抓住、不犹豫。',
        田: '田主根基与产业，财运宜稳守，适合购置不动产或长期持有。',
        仓: '仓主积蓄与储备，财运宜先储蓄后消费，量入为出。',
        商: '商主交易与流通，财运宜主动出击，拓展客源与渠道。',
        利: '利主收益与回报，财运向好，但需警惕过劳与贪心。',
        债: '债主压力与拖累，财运可能有负债或资金紧张，宜谨慎借贷。',
      },
      health: {
        水: '水主肾与血液，健康上需关注肾脏、血液循环，适当补水、避免熬夜。',
        火: '火主心脏与血压，健康上需关注心血管，避免情绪过激、饮食过辣。',
        木: '木主肝胆，健康上需疏肝解郁，避免情绪压抑，多亲近自然。',
        金: '金主肺与呼吸，健康上需关注呼吸系统，避免烟尘、戒烟。',
        土: '土主脾胃，健康上需调养脾胃，饮食规律、忌生冷油腻。',
        气: '气主生命力，健康上需调息养气，适度运动、充足睡眠。',
        眠: '眠主睡眠，健康上需改善睡眠质量，忌熬夜、睡前屏弃电子。',
        骨: '骨主筋骨，健康上需锻炼筋骨，适当运动、防跌摔。',
      },
      travel: {
        舟: '舟主远行，出行顺畅，适合远途旅行或出差，宜备好行囊。',
        车: '车主奔波与快速，出行节奏较快，注意交通安全、防疲劳驾驶。',
        路: '路主前行，出行顺利，但可能有绕路或延误，宜预留时间。',
        山: '山主阻隔，出行可能遇阻或天气不佳，宜改期或备选方案。',
        风: '风主变化，出行计划可能有变动，宜保持灵活。',
        云: '云主漂泊与不定，出行可能有临时取消或改签，宜多备预案。',
        水: '水主流动，出行宜近不宜远，避免水灾或潮湿地区。',
        驿: '驿主中途停留，出行可能有中途歇脚或转机，不必赶。',
      },
      study: {
        书: '书主学问，学业上有收获，宜多读书、勤复习，忌拖延。',
        笔: '笔主表达与创作，学业上适合写论文或考试发挥，宜充分准备。',
        窗: '窗主专注与静修，学业上需排除干扰、静心学习。',
        墨: '墨主沉淀与积累，学业上需厚积薄发，忌急于求成。',
        灯: '灯主指引与启发，学业上有老师或贵人指点迷津，宜虚心请教。',
        琴: '琴主韵律与节奏，学业上宜按部就班、劳逸结合，忌熬夜赶工。',
        经: '经主经典与基础，学业上需夯实基础、多读经典，忌好高骛远。',
        学: '学主进步，学业向上，宜保持热情与专注。',
      },
    };
    var domainInterp = interpretations[domainKey] || interpretations['career'];
    // 多意象匹配：收集句中所有匹配意象（最多2个），合并解读
    var matched = [];
    for (var key in domainInterp) {
      if (matched.length >= 2) break;
      if (line.indexOf(key) >= 0) matched.push(domainInterp[key]);
    }
    if (matched.length > 0) return matched.join('');
    // 事域级 fallback：没有意象匹配时，根据签文结构给具体指引
    ...
    if (trimmed.length <= 8) {
      return '此句短促有力，' + domainLabel + '上提示当前局面较为直接，宜直面无迂回，抓住关键矛盾。';
    } else if (trimmed.length > 20) {
      return '此句意象丰富，' + domainLabel + '上提示事态较复杂，需综合各方面因素权衡，不可偏听偏信。';
    } else if ('吉凶得失成败进退'.split('').some(function(c){ return trimmed.indexOf(c) !== -1; })) {
      return '此句含吉凶暗示，' + domainLabel + '上需结合签等判断，吉则顺势、凶则守正。';
    } else {
      return '此句平铺直叙，' + domainLabel + '上提示当前状态平稳，宜保持现状、伺机而动，不急于改变。';
    }
  }
